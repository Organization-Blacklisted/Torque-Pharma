...
export default function DirectorSection({
  ...
  return (
    <div className={`rounded-lg bg-dark-blue py-[var(--spacing-section-inner)] ${className}`}>
      <Container size="wide">
      <div className="grid gap-[var(--spacing-column-gap)] items-center lg:grid-cols-[1.2fr_1fr]">
      {/* Text */}
      <div>
        <h2 className="font-body text-[24px] font-medium leading-normal text-white uppercase mb-1">
          {name}
        </h2>
        <p className="font-body text-body text-white/60 mb-[var(--spacing-subsection)]">
          {designation}
        </p>

        <p className="font-body text-body font-normal leading-6 text-white/60 mb-[var(--spacing-subsection)]">
          {about}
        </p>

        {/* Blockquote */}
        <blockquote className="relative border-l-[3px] border-mint rounded-t-lg bg-white/[0.08] py-6 pl-6 pr-14">
