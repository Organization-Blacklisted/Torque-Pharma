...
import { submitExportEnquiry } from "@/lib/actions/export-enquiry";
...
const schema = z.object({
  ...
  areaOfInterest:      z.string().min(1, "Please select a buyer type"),
...
function SuccessState() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
      ...
      <p className="text-body text-secondary">Thank you for your export enquiry. Our team will review your requirements and get back to you shortly.</p>
    </div>
  );
}
...
export default function ExportForm() {
  ...
  const {
    ...
    defaultValues: {
      ...
      state: "", areaOfInterest: "", productCategory: "", expectedOrderVolume: "", message: "",
    },
  });
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    const result = await submitExportEnquiry({
