...
import { submitWhiteLabelEnquiry } from "@/lib/actions/white-label-enquiry";
...
const schema = z.object({
  ...
  productFormat: z.string().min(1, "Please select a product format"),
...
function SuccessState() {
  return (
    <div className="flex flex-col items-center justify-center gap-4 py-16 text-center">
      ...
      <p className="text-body text-secondary">Thank you for your white-label enquiry. Our team will review your requirements and get back to you shortly.</p>
    </div>
  );
}
...
export default function WhiteLabelForm() {
  ...
  const {
    ...
    defaultValues: {
      ...
      state: "", productType: "", productFormat: "", quantity: "", message: "",
    },
  });
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    const result = await submitWhiteLabelEnquiry({
      ...
      product_format: data.productFormat,
